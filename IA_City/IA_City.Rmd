...
danger = ggmap(iac_city_map) +
    geom_point(data=topstreets, aes(x=X, y=Y, color=count), size=10) + 
    geom_text_repel(data=topstreets, aes(label=LITERAL, color=count), size=8, nudge_y=-0.1, nudge_x=-0.2, label.padding=2, box.padding=2, show.legend=FALSE) +
